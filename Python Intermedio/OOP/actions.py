...
class Student:
    ...
    def __init__(self, full_name,grade_section,spanish_grade, english_grade, social_studies_grade, science_grade):
...
def create_student(students):
    ...
    if student_exists(students, name, section):
        ...
        student = Student(
            name,
            section,
            get_student_spanish_grade(),
            get_student_english_grade(),
            get_student_social_studies_grade(),
            get_student_science_grade()
        )
...
def show_csv(students):
    ...
    for student in students:
        ...
        print(f"Section: {student.grade_section}")
